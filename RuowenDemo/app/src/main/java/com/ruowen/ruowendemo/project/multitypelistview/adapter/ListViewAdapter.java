package com.ruowen.ruowendemo.project.multitypelistview.adapter;
...
import com.ruowen.ruowendemo.common.util.DpUtils;
...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup arg2) {
        ...
        if (null == convertView){
            Log.d("ruowen", "ruowen>>>>>>>>>>>>type="+type+", position="+position+", convertView null");
        }else{
            Log.d("ruowen", "ruowen>>>>>>>>>>>>type="+type+", position="+position+", convertView not null");
        }
